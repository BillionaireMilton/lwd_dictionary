...
class _CatListPageState extends State<CatListPage> {
  ...
  void initState() {
    ...
    CategoryListServices.getCategoriesList(this.widget.category)
  ...
  // getQuotesByCategories() async {
  //   var quotes = await _sortService.getCategory(this.widget.category);
  //   quotes.forEach((quotes){
  //     setState(() {
  //       var model = Quote();
  //       model.id = quotes['id'];
  //       model.category_name = quotes['category_name'];
